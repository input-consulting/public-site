...
IF /I "bower.json" NEQ "" (  
  echo Installing Bower dependencies: Starting %TIME%
  call npm install bower
  echo Installing Bower dependencies: Finished %TIME%
  IF !ERRORLEVEL! NEQ 0 goto error
  echo Running Bower deployment: Starting %TIME%
  call :ExecuteCmd "%DEPLOYMENT_SOURCE%\node_modules\.bin\bower" install
  echo Running Bower deployment: Finished %TIME%
  IF !ERRORLEVEL! NEQ 0 goto error
)
